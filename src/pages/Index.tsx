      ...
      <footer className="text-white py-12" style={{background: `url('https://cdn.poehali.dev/files/db4ae80e-dbb8-4534-a07a-f33cfa23d35a.jpg') center/cover`}}>
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
            <a href="tel:+79184141221" className="flex items-center gap-2 text-white hover:text-gold-400 transition-all duration-300 cursor-pointer">
              <Icon name="Phone" size={20} />
              <span>+7(918) 414-1221</span>
            </a>
            <a href="https://t.me/velikaya_nataliya" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white hover:text-gold-400 transition-all duration-300 cursor-pointer">
              <Icon name="Send" size={20} />
              <span>@velikaya_nataliya</span>
            </a>
            <a href="https://t.me/NewWorld7d" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white hover:text-gold-400 transition-all duration-300 cursor-pointer">
              <Icon name="Send" size={20} />
              <span>Новый Мир 🌍</span>
            </a>
            <a href="https://youtube.com/channel/UCZ_Ukxv92QcpaTUzIKKS4VA" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white hover:text-gold-400 transition-all duration-300 cursor-pointer">
