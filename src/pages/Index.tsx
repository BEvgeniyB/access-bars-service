  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-900 font-openSans relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-10">
        <div className="absolute top-20 left-10 text-gold-400/30 text-8xl transform rotate-12 select-none" style={{fontFamily: 'Dancing Script, cursive', fontWeight: 600}}>
          Natalia
        </div>
        <div className="absolute top-40 right-20 text-gold-400/30 text-8xl transform -rotate-12 select-none" style={{fontFamily: 'Dancing Script, cursive', fontWeight: 600}}>
          Natalia
        </div>
        <div className="absolute top-80 left-1/3 text-gold-400/30 text-8xl transform rotate-6 select-none" style={{fontFamily: 'Dancing Script, cursive', fontWeight: 600}}>
          Natalia
        </div>
        <div className="absolute bottom-40 right-10 text-gold-400/30 text-8xl transform -rotate-6 select-none" style={{fontFamily: 'Dancing Script, cursive', fontWeight: 600}}>
          Natalia
        </div>
        <div className="absolute bottom-20 left-20 text-gold-400/30 text-8xl transform rotate-45 select-none" style={{fontFamily: 'Dancing Script, cursive', fontWeight: 600}}>
          Natalia
        </div>
        <div className="absolute top-60 right-1/3 text-gold-400/30 text-8xl transform -rotate-45 select-none" style={{fontFamily: 'Dancing Script, cursive', fontWeight: 600}}>
          Natalia
        </div>
      </div>
      {/* Header */}
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="text-center py-3 border-b border-gold-400/20 relative">
            ...
            <img 
              ...
              alt="Natalia" 
              className="absolute top-1/2 left-0 -translate-y-1/2 w-20 h-12 object-contain opacity-90 hover:opacity-100 transition-opacity mix-blend-screen"
              style={{filter: 'invert(1) brightness(0.8) sepia(1) saturate(3) hue-rotate(15deg)'}}
            />
