  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-900 font-openSans relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-10">
        <div className="absolute top-20 left-10 text-gold-400/30 text-8xl transform rotate-12 select-none" style={{fontFamily: 'Bakbak One, sans-serif'}}>
          Natalia
        </div>
        <div className="absolute top-40 right-20 text-gold-400/30 text-8xl transform -rotate-12 select-none" style={{fontFamily: 'Bakbak One, sans-serif'}}>
          Natalia
        </div>
        <div className="absolute top-80 left-1/3 text-gold-400/30 text-8xl transform rotate-6 select-none" style={{fontFamily: 'Bakbak One, sans-serif'}}>
          Natalia
        </div>
        <div className="absolute bottom-40 right-10 text-gold-400/30 text-8xl transform -rotate-6 select-none" style={{fontFamily: 'Bakbak One, sans-serif'}}>
          Natalia
        </div>
        <div className="absolute bottom-20 left-20 text-gold-400/30 text-8xl transform rotate-45 select-none" style={{fontFamily: 'Bakbak One, sans-serif'}}>
          Natalia
        </div>
        <div className="absolute top-60 right-1/3 text-gold-400/30 text-8xl transform -rotate-45 select-none" style={{fontFamily: 'Bakbak One, sans-serif'}}>
          Natalia
        </div>
      </div>
      {/* Header */}
