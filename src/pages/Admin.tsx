...
const Admin = () => {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-gold-50">
        <Header />
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="font-montserrat font-bold text-4xl text-emerald-800 mb-4">
              <Icon name="Settings" size={40} className="inline mr-2" />
              Админ-панель услуг
            </h1>
            <p className="text-emerald-600 text-lg">
              Управление наименованиями и ценами услуг
            </p>
          </div>
