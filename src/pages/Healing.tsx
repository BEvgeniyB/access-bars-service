    ...
    <div className="min-h-screen relative overflow-hidden" style={{background: `url('https://cdn.poehali.dev/files/19fd920a-9d96-45d1-9b4a-8e0584e2a051.jpg') center/cover no-repeat fixed`}}>
        ...
        <div className="container mx-auto px-4 py-2 md:py-4 relative">
          ...
          <div className="block md:hidden">
            ...
            <nav className="flex justify-center gap-4 text-xs">
              ...
              <a href="/healing" className="text-gold-400 font-medium">Целительство</a>
            </nav>
          </div>
      ...
      <div className="fixed bottom-4 left-4 md:top-16 md:bottom-auto md:left-2 md:right-auto z-40">
        <div className="group">
          ...
          <div id="section-menu" className="hidden absolute bottom-12 md:top-12 md:bottom-auto left-0 w-64 bg-black/90 border-2 border-gold-400/50 rounded-lg shadow-2xl overflow-hidden">
