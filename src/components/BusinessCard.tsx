            ...
            <div className="relative z-10">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="https://bodyhealing.ru" target="_blank" rel="noopener noreferrer" className="text-emerald-100 hover:text-gold-200 transition-colors">https://velikaya-nataliya.ru/</a>
                </div>
