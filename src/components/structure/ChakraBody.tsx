...
const ChakraBody = ({ chakras, onChakraClick }: ChakraBodyProps) => {
  ...
  const getChakraPosition = (position: number) => {
    const positions = [
      ...
      { top: '70%', left: '52%' },  // 4 - зеленый узор (сдвинуто влево на 15мм)
      { top: '42%', left: '60%' },  // 5 - голубой узор (сдвинуто влево на 15мм)
      { top: '22%', left: '52%' },  // 6 - синий ромб (сдвинуто влево на 15мм)
